...
<html lang="en">
  ...
  <body>
    <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark">
      <div class="container">
      <a class="navbar-brand" href="index.php">KELOMPOK 9</a>
      <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNavAltMarkup" aria-controls="navbarNavAltMarkup" aria-expanded="false" aria-label="Toggle navigation">
        <span class="navbar-toggler-icon"></span>
      </button>
      <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav">
          <a class="nav-item nav-link" href="#kriptografi1">Kriptografi 1 <span class="sr-only">(current)</span></a>
          <a class="nav-item nav-link" href="#kriptografi2">Kriptografi 2</a>
        </div>
      </div>
      </div>
    </nav>
    
    <section id="home" class="home mt-5" style="background-color: #dcdcdc;">
        <div class="container">
            <div class="row">
              <div class="col" style="margin-top: 100px;">
                <h2 align="center">KELOMPOK 9</h2> <br><br>
              </div>
            </div>
        </div>
        <div class="container">
            <div class="row">
              <div class="col">
                <b> <p align="center">Muhammad Syahwal (60200117042)<br><br>
                   Isra Abdi Syamsu (60200117055)<br><br>
                   Muhammad Azhar Aidil (60200117060)</p></b> <br>
                <p align="center">Tugas ini adalah tugas mata kuliah keamanan digital tentang kriptografi</p>
    ...
    <section id="kriptografi1" class="kriptografi1" style="background-color: #c0c0c0;">
    <div class="container">
        <div class="row">
          <div class="col text-center"><br>
            <h2 style="margin-top: 70px;">KRIPTOGRAFI ALGORITMA RSA</h2> <br><br><br>
            <form method="post">
                <center>
                <table>
                  <tr>
                  <td>Plain Teks </td><td>Chipper Teks </td><td>Plain Teks</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                  <td>Public Key</td><td>Private Key</td><td>Waktu Eksekusi</td>
                  </tr>
                  <tr>
  ...
  <section id="kriptografi2" class="kriptografi2" style="background-color: #dcdcdc;">
      <div class="container">
          <div class="row">
            <div class="col text-center">
              <h2 style="margin-top: 70px;">KRIPTOGRAFI ALGORITMA AES-256</h2>
               <br><br>
